...
@Service
class ProjectEventsSubscriberExmp {

    val logger: Logger = LoggerFactory.getLogger(ProjectEventsSubscriberExmp::class.java)
    ...
    @PostConstruct
    fun init() {
//        subscriptionsManager.createSubscriber(ProjectAggregateExmp::class, "some-meaningful-name") {
